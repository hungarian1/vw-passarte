...
-- Trabalhadores
-- ------------------------------------------------------------------------
INSERT INTO Trabalhador (nome, genero, nacionalidade, nif, num_telefone, data_nascimento) VALUES
('Ana Ferreira',    'MULHER', 'Portuguesa',  '123456789', '912345678', '1985-03-12'),
('Carlos Mendes',   'HOMEM',  'Português',   '234567891', '923456789', '1979-07-24'),
('Sofia Lopes',     'MULHER', 'Portuguesa',  '345678912', '934567890', '1992-11-05'),
('João Rodrigues',  'HOMEM',  'Português',   '456789123', '945678901', '1988-01-30'),
('Mariana Costa',   'MULHER', 'Brasileira',  '567891234', '956789012', '1995-06-18');
...
-- Visitantes
-- ------------------------------------------------------------------------
INSERT INTO Visitante (nome, data_nascimento, nif, genero, nacionalidade, telefone, email, idTrabalhador) VALUES
...
-- Mestres do Renascimento (Exp 1)
(1, 1), (1, 2), (1, 3),
-- Sonhos e Obsessões (Exp 2)
(2, 9), (2, 10),
-- Luz e Cor (Exp 3)
(3, 6), (3, 7), (3, 8),
-- Formas Partidas (Exp 4)
(4, 11), (4, 12),
-- Mulheres na Arte (Exp 5) — obras de Frida, Artemisia e Georgia
(5, 4), (5, 13), (5, 14),
-- O Corpo e o Espírito (Exp 6)
(6, 4), (6, 5);
